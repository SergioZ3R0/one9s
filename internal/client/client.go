...
// This enables mocking for tests and decouples from GOCA.
...
// MapVMState translates numeric VM state to human-readable string.
func MapVMState(state, lcm int) string {
	...
	// 12=HOLD, 13=STOPPED, 14=SUSPENDED, 15=POWEROFF, 16=UNPKNOWN,
	// 17=ACTIVE
	states := map[int]string{
		0: "INIT", 1: "READY", 2: "BOOT_POWEROFF", 3: "BOOT_SUSPENDED",
		4: "BOOT_STOPPED", 5: "SHUTDOWN", 6: "UNDEPLOYED", 7: "BOOT_UNDEPLOYED",
		8: "HOTPLUG", 9: "CLONING", 10: "CLONING_FAILURE", 11: "UNKNOWN",
		12: "HOLD", 13: "STOPPED", 14: "SUSPENDED", 15: "POWEROFF", 16: "UNKNOWN",
		17: "ACTIVE",
	}
	s, ok := states[state]
	if !ok {
	...
	if state == 17 {
		// ACTIVE sub-states via LCM_STATE
		lcmStates := map[int]string{
